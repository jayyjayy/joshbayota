...
if(isset($_POST['add_product'])){
   ...
   $product_Images_folder = 'image/'.$product_image;
...
<div class="container">
   ...
   <div class="admin-product-form-container">
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         ...
         <input type="text" placeholder="enter destination name" name="product_name" class="box">
         <input type="number" placeholder="enter price" name="product_price" class="box">
         <input type="file" accept="image/png, image/jpeg, image/jpg" name="product_image" class="box">
         <input type="submit" class="btn" name="add_product" value="add product">
         <p input type="submit" class="btn"><a href="http://localhost/josh/helloworld.php">Home</a></p>
      </form>
   ...
   $select = mysqli_query($conn, "SELECT * FROM joshweb");
